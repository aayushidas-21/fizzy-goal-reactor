# Fizzy Goal Reactor
> **Gamifying Productivity and Accountability with 3D Bubbly Urgency**
...
👉 **[Live App Link](https://fizzy-goal-reactor.vercel.app/)**
...
*   **Visual Urgency (PSI System):** As deadlines draw near, bubbles scale up, shake, and transition from blue to warning-yellow and panic-red.
...
*   **Mechanical Focus Coolant Pump:** Pull the 3D spring handle Pomodoro lever to vent steam particles and flood the reactor with cooling gas, extending deadlines.
...
*   **Flavor Lab Shop and Customizer:** Earn Fizzy Gold to buy Streak Shields, Pressure Regulators, or unlock glowing fluid wave aesthetics (Peach, Lime, Royal Purple, Cherry).
